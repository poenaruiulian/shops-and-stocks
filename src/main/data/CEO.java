...
public class CEO extends Person{
    ...
    public void transferEmployee(int employeeId, int shopId){
        ...
        currentShopEmployeesList.remove(employee);
    ...
    public void fireManager(int managerID, int shopID){
        ...
        this.employeeList = this.employeeList.stream().filter(employee -> employee.userID!=managerToRemove.userID).toList();
        FileProcessing.updateUserInFile(this);
    ...
    public void fireEmployee(int employeeID, int shopID){
        ...
        this.employeeList = this.employeeList.stream().filter(employee -> employee.userID!=employeeToFire.userID).toList();
        FileProcessing.updateUserInFile(this);
